...
const faqs = [
  ...
  { q: "What thermal resolution do your drones capture?", a: "We utilize radiometric thermal sensors capturing at 640x512 resolution with a temperature sensitivity of â‰¤50 mK, ensuring even the smallest micro-cracks are detected." },
